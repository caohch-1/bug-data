...
public class TestTaskAttemptListenerImpl {
  ...
  private void nmHang(MockTaskAttemptListenerImpl listener, JvmContext context) throws IOException {
    while (listener.getTask(context) == null) {
      System.out.println("Try to get Task jID");
    }
  }
  ...
  public void testGetTask() throws IOException {
    ...
    // Normal run
    listener.register(attemptID, task, wid);
    listener.unregister(attemptID, wid);
    nmHang(listener, context);

    // Buggy run
    listener.register(attemptID, task, wid);
    nmHang(listener, context);
    listener.unregister(attemptID, wid);
    System.out.println("Got Task jID");
