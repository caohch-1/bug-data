...
# trace_extractor.save_traces("./traces/F20/normal")
trace_extractor.save_traces("./traces/F20/buggy")
    
log_extractor = LogExtractor()
# log_extractor.extract_all("./logs/F20/normal")
log_extractor.extract_all("./logs/F20/buggy")