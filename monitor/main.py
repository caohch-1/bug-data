...
trace_extractor.save_traces("./traces/F17/normal")
# trace_extractor.save_traces("./traces/F17/buggy")
    
log_extractor = LogExtractor()
log_extractor.extract_all("./logs/F17/normal")
# log_extractor.extract_all("./logs/F17/buggy")